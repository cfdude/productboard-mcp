...
- Multi-field filtering with intelligent suggestions
    ...
    get_performance_metrics: {
        description: 'Monitor MCP server performance with intelligent caching and optimization',
        detailedDescription: `
...
- Analyze usage patterns
    ...
    bulk_update_features: {
        description: 'Update multiple features efficiently with diff-only processing',
        detailedDescription: `
...
- Parallel processing for independent updates
    ...
    set_user_context: {
        description: 'Set intelligent response adaptation based on user preferences and context',
        detailedDescription: `
...
Supports pagination for large result sets and multiple filter combinations.
    ...
    search: {
        description: 'Universal search across all ProductBoard entities with intelligent filtering, field selection, and output formatting',
...
`,
        examples: [
            ...
            },
            {
                ...
                notes: 'Use this to discover custom field names for use in update_feature calls',
            },
            {
                ...
                notes: 'Custom fields will be included in the response with names, values, and metadata',
            },
        ],
        commonErrors: [
            {
            ...
            },
            {
                ...
                cause: 'Components only contain parent.product.id, not parent.name or parent.product.name fields',
                solution: 'CRITICAL: Use two-step search: 1) Find product by name to get ID, 2) Search components by parent.product.id',
            },
            {
                error: 'Components search returns empty for name-based filters',
                cause: 'Trying to search components with parent.product.name, parent.name, or product.name - these fields do not exist in component data',
                solution: 'Step 1: search({entityType: "products", filters: {"name": "ProductName"}}) to get product ID. Step 2: search({entityType: "components", filters: {"parent.product.id": "product-uuid-from-step-1"}})',
            },
            {
                error: 'Limit exceeds maximum',
...
**Custom Fields Support**: Set \`includeCustomFields: true\` to retrieve all custom field values for the feature along with field metadata and available options.
    `,
        examples: [
            ...
            },
            {
                ...
                notes: 'Custom fields section will include field names, values, types, and available options',
            },
            {
                ...
                notes: 'Use basic detail level for faster responses when full data not needed',
            },
        ],
        commonErrors: [
            {
                ...
                solution: 'Verify feature ID exists using list_features or search tools',
            },
        ],
        bestPractices: [
    ...
    update_feature: {
        description: 'Update an existing feature with new information, custom fields, or move it to a different component/product',
        detailedDescription: `
    ...
    `,
        examples: [
            ...
            },
            {
                ...
                description: 'Update both standard feature properties and custom fields',
                input: {
                    id: 'feat-123',
        ...
        commonErrors: [
            ...
            },
            {
                ...
                solution: 'Use get_custom_fields tool to see available fields, check spelling of field names',
            },
            {
                error: 'Invalid dropdown value',
                cause: 'Dropdown value does not match available options',
                solution: 'Check available dropdown options or use user-friendly values that match existing options',
            },
        ],
        bestPractices: [
