    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          pageLimit: {
            type: "string",
            description: "pageLimit parameter (optional)"
          },
          pageOffset: {
            type: "string",
            description: "pageOffset parameter (optional)"
          },
          term: {
            type: "string",
            description: "term parameter (optional)"
          },
          hasNotes: {
            type: "string",
            description: "hasNotes parameter (optional)"
          },
          featureId: {
            type: "string",
            description: "featureId parameter (optional)"
          },
          instance: {
            type: "string",
            description: "instance parameter (optional)"
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          companyId: {
            type: "string",
            description: "companyId parameter"
          },
...
export async function companyCreate(args: any) {
...
export async function companiesGet(args: any) {
  return await withContext(async (context) => {
...
export async function companyGet(args: any) {
  return await withContext(async (context) => {
...
export async function companyDelete(args: any) {
  return await withContext(async (context) => {
...
export async function companyListFields(args: any) {
  return await withContext(async (context) => {
...
export async function companyGetField(args: any) {
  return await withContext(async (context) => {
...
export async function companyDeleteField(args: any) {
  return await withContext(async (context) => {
...
export async function companyGetFieldvalue(args: any) {
  return await withContext(async (context) => {
...
export async function companyDeleteFieldvalue(args: any) {
  return await withContext(async (context) => {
...
export async function usersGet(args: any) {
  return await withContext(async (context) => {
...
export async function userGet(args: any) {
  return await withContext(async (context) => {
...
export async function userDelete(args: any) {
  return await withContext(async (context) => {
