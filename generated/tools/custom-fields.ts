...
export async function customGetFields(args: any) {
...
export async function customGetFieldsvalues(args: any) {
  return await withContext(async (context) => {
...
export async function customGetField(args: any) {
  return await withContext(async (context) => {
...
export async function customGetFieldvalue(args: any) {
  return await withContext(async (context) => {
...
export async function customSetFieldvalue(args: any) {
  return await withContext(async (context) => {
...
export async function customDeleteFieldvalue(args: any) {
  return await withContext(async (context) => {
