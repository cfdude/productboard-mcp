...
;
export async function handlePluginIntegrationsTool(name, args) {
    switch (name) {
...
export async function pluginPostIntegration(args) {
...
export async function pluginGetIntegrations(args) {
    return await withContext(async (context) => {
...
export async function pluginGetIntegration(args) {
    return await withContext(async (context) => {
...
export async function pluginPatchIntegration(args) {
    return await withContext(async (context) => {
...
export async function pluginPutIntegration(args) {
    return await withContext(async (context) => {
...
export async function pluginDeleteIntegration(args) {
    return await withContext(async (context) => {
...
export async function pluginGetIntegrationconnections(args) {
    return await withContext(async (context) => {
...
export async function pluginGetIntegrationconnection(args) {
    return await withContext(async (context) => {
...
export async function pluginPutIntegrationconnection(args) {
    return await withContext(async (context) => {
        const response = await context.axios.put($2, args.args.body);
        return {
            content: [{
...
export async function pluginDeleteIntegrationconnection(args) {
    return await withContext(async (context) => {
